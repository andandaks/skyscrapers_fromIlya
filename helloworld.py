...
with st.echo(code_location='below'):
    ...
    def go():
        ...
        st.subheader('А теперь ещё одна интересная фича. '
                     ...
                     ' Вы можете зайти в телеграм-бот @Skyscrapersplustextbot ([он](https://github.com/andandaks/telegasky/blob/main/telega.py) выключен, автор жлоб) и попробовать повоображать '
        ...
        st.write('**SQL. 1** Используется для резервного хранения фотографий в телеграм-боте')
        ...
        st.write('**Дополнительные технологии. 1-2**'
                 ' Тема с надписями на картинках делалась через библиотеку pillow, которую мы не проходили. Ещё и тг-бот есть. Сказка.')
        st.write('**Объем. 1**'
                 ' Больше 190. (Отдельный файл с тг ботом тоже учитывается)')
